...
rename(Data_Limpia_3, Biotecnologia = biotech, Software = software, M�vil = mobile, Tecnologia_limpia = cleantech, Empresa = enterprise, Web = web, Medicinal = medical, Publicidad = advertising, Comercio_Electronico = ecommerce, Servidor_de_Red = network_hosting, Semiconductor = semiconductor, Hardware = hardware, Video_Juegos = games_video, Analitica = analytics, Seguridad = security, Social = social, Finanzas = finance, Salud = health, Nanotecnologia = nanotech, Relaciones_Publicas = public_relations, Automotora = automotive, Otros = other, Buscar = search, Educaci�n = education, Fabricaci�n = manufacturing, Noticias = news, Moda = fashion, Viaje = travel, Mensajeria = messaging, Consultoria = consulting, Transporte = transportation, Musica = music, Foto_Video = photo_video, Hoteleria = hospitality, Bienes_Raices = real_estate, Organizaci�n_sin_fines_de_lucro = nonprofit, Legal = legal, Dise�o = design, Deportes = sports, Local = local, Mascotas = pets, Gobierno = government)
